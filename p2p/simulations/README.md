...
creating a collection of devp2p nodes, connecting them toghucer to form a
...
RPC ports (`50505` and `8546` respectively).
...
As a concrete example, consider a simulated network of HappyUC nodes. An
