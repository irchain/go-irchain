...
// MainnetGenesis returns the JSON spec to use for the main IrChain network. It
// is actually empty since that defaults to the hard coded binary genesis block.
func MainnetGenesis() string {
	return ""
}

// TestnetGenesis returns the JSON spec to use for the IrChain test network.
...
// FoundationBootnodes returns the hnode URLs of the P2P bootstrap nodes operated
