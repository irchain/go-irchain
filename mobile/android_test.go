...
public class AndroidTest extends InstrumentationTestCase {
	...
	public void testAccountManagement() {
		...
		KeyStore ks = new KeyStore(getInstrumentation().getContext().getFilesDir() + "/keystore", Ghuc.LightScryptN, Ghuc.LightScryptP);
...
func TestAndroid(t *testing.T) {
	// Skip tests on Windows altoghucer
	...
	for _, dir := range []string{"src/main", "src/androidTest/java/org/happyuc/ghuctest", "libs"} {
