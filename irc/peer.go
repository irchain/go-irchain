...
// PeerInfo represents a short summary of the IrChain sub-protocol metadata known
// about a connected peer.
type PeerInfo struct {
	Version    int      `json:"version"`    // IrChain protocol version negotiated
...
// Handshake executes the irc protocol handshake, negotiating version number,
...
func (p *peer) String() string {
	return fmt.Sprintf("Peer %s [%s]", p.id,
		fmt.Sprintf("irc/%2d", p.version),
	)
}

// peerSet represents the collection of active peers currently participating in
// the IrChain sub-protocol.
type peerSet struct {
