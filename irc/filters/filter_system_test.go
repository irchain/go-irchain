...
func (b *testBackend) ChainDb() ircdb.Database {
	return b.db
}
...
func TestBlockSubscription(t *testing.T) {
	...
	var (
		...
		chain, _    = core.GenerateChain(params.TestChainConfig, genesis, irchash.NewFaker(), db, 10, func(i int, gen *core.BlockGen) {})
