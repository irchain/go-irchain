...
// information related to the IrChain protocol such als blocks, transactions and logs.
...
// `irc_getFilterChanges` polling method that is also used for log filters.
//
// https://github.com/irchain/wiki/wiki/JSON-RPC#irc_newpendingtransactionfilter
...
// It is part of the filter package since polling goes with irc_getFilterChanges.
//
// https://github.com/irchain/wiki/wiki/JSON-RPC#irc_newblockfilter
...
func (api *PublicFilterAPI) Logs(ctx context.Context, crit FilterCriteria) (*rpc.Subscription, error) {
	...
	logsSub, err := api.events.SubscribeLogs(irchain.FilterQuery(crit), matchedLogs)
	if err != nil {
		return nil, err
	}
...
type FilterCriteria irchain.FilterQuery
...
//
// https://github.com/irchain/wiki/wiki/JSON-RPC#irc_newfilter
func (api *PublicFilterAPI) NewFilter(crit FilterCriteria) (rpc.ID, error) {
	logs := make(chan []*types.Log)
	logsSub, err := api.events.SubscribeLogs(irchain.FilterQuery(crit), logs)
	if err != nil {
		return rpc.ID(""), err
	}
...
//
// https://github.com/irchain/wiki/wiki/JSON-RPC#irc_getlogs
...
//
// https://github.com/irchain/wiki/wiki/JSON-RPC#irc_uninstallfilter
...
//
// https://github.com/irchain/wiki/wiki/JSON-RPC#irc_getfilterlogs
...
//
// https://github.com/irchain/wiki/wiki/JSON-RPC#irc_getfilterchanges
