...
var ProtocolName = "irc"

// ProtocolVersions are the upported versions of the irc protocol (first is primary).
var ProtocolVersions = []uint{irc63, irc62}
...
// irc protocol message codes
const (
	// Protocol messages belonging to irc/62
	StatusMsg          = 0x00
	...
	// Protocol messages belonging to irc/63
	GetNodeDataMsg = 0x0d
	NodeDataMsg    = 0x0e
	GetReceiptsMsg = 0x0f
	ReceiptsMsg    = 0x10
