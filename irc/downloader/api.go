...
// Syncing provides information when this nodes starts synchronising with the IrChain network and when it's finished.
...
type SyncingResult struct {
	...
	Status  irchain.SyncProgress `json:"status"`
}
