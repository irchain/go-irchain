...
type Fetcher struct {
	...
	fetchingHook       func([]common.Hash)     // Method to call upon starting a block (irc/61) or header (irc/62) fetch
	completingHook     func([]common.Hash)     // Method to call upon starting a block body fetch (irc/62)
	importedHook       func(*types.Block)      // Method to call upon successful block import (both irc/61 and irc/62)
}
