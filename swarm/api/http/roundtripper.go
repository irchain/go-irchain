...
see https://github.com/happyuc-project/happyuc-go/issues/2040
Usage:

import (
 "github.com/happyuc-project/happyuc-go/common/httpclient"
 "github.com/happyuc-project/happyuc-go/swarm/api/http"
)
