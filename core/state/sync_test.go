...
func makeTestState() (Database, common.Hash, []*testAccount) {
	...
	db := NewDatabase(hucdb.NewMemDatabase())
...
// account array.
func checkStateAccounts(t *testing.T, db hucdb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db hucdb.Database, root common.Hash) error {
...
func checkStateConsistency(db hucdb.Database, root common.Hash) error {
...
func TestEmptyStateSync(t *testing.T) {
	...
	if req := NewStateSync(empty, hucdb.NewMemDatabase()).Missing(1); len(req) != 0 {
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(hucdb.Database), srcRoot)
