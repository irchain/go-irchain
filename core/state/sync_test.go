...
func makeTestState() (Database, common.Hash, []*testAccount) {
	...
	db := NewDatabase(ircdb.NewMemDatabase())
...
// account array.
func checkStateAccounts(t *testing.T, db ircdb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db ircdb.Database, root common.Hash) error {
...
func checkStateConsistency(db ircdb.Database, root common.Hash) error {
...
func TestEmptyStateSync(t *testing.T) {
	...
	if req := NewStateSync(empty, ircdb.NewMemDatabase()).Missing(1); len(req) != 0 {
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(ircdb.Database), srcRoot)
