...
type Trie interface {
	...
	Prove(key []byte, fromLevel uint, proofDb ircdb.Putter) error
}
...
func NewDatabase(db ircdb.Database) Database {
...
func (m cachedTrie) Prove(key []byte, fromLevel uint, proofDb ircdb.Putter) error {
