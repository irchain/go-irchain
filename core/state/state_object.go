...
// stateObject represents an IrChain account which is being modified.
//
...
type stateObject struct {
	...
	addrHash common.Hash // hash of irchain address of the account
	data     Account
	db       *StateDB
...
// Account is the IrChain consensus representation of accounts.
