...
// Whisper represents a dark communication interface through the HappyUC
...
// New creates a Whisper client ready to communicate through the HappyUC P2P network.
