...
// Whisper represents a dark communication interface through the IrChain
...
// New creates a Whisper client ready to communicate through the IrChain P2P network.
