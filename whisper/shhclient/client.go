...
func (sc *Client) MarkTrustedPeer(ctx context.Context, hnode string) error {
	var ignored bool
	return sc.c.CallContext(ctx, &ignored, "shh_markTrustedPeer", hnode)
}
...
func (sc *Client) SubscribeMessages(ctx context.Context, criteria whisper.Criteria, ch chan<- *whisper.Message) (irchain.Subscription, error) {
