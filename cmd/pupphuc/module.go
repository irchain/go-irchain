...
// returned from docker inspect, parsed into a form easily usable by pupphuc.
type containerInfos struct {
	running bool              // Flag whhucer the container is running currently
...
func inspectContainer(client *sshClient, container string) (*containerInfos, error) {
	// Check whhucer there's a container running for the service
	...
	// Infos retrieved, parse the above into somhucing meaningful
