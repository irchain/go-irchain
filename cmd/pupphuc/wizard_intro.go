...
// setting up a new or managing an existing HappyUC private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your HappyUC private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new HappyUC network down to  |")
	fmt.Println("| the genesis block, bootnodes, miners and hucstats servers |")
	...
	log.Info("Administering HappyUC network", "name", w.network)
