...
// setting up a new or managing an existing IrChain private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your IrChain private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new IrChain network down to  |")
	fmt.Println("| the genesis block, bootnodes, miners and ircstats servers |")
	...
	log.Info("Administering IrChain network", "name", w.network)
