...
import (
	...
	"github.com/irchain/go-irchain/common/compiler"
)

var (
	abiFlag = flag.String("abi", "", "Path to the IrChain contract ABI json to bind, - for STDIN")
	binFlag = flag.String("bin", "", "Path to the IrChain contract bytecode (generate deploy method)")
	typFlag = flag.String("type", "", "Struct name for the binding (default = package name)")

	solFlag  = flag.String("sol", "", "Path to the IrChain contract Solidity source to build and bind")
