...
import (
	...
	"github.com/happyuc-project/happyuc-go/common/compiler"
)

var (
	abiFlag = flag.String("abi", "", "Path to the HappyUC contract ABI json to bind, - for STDIN")
	binFlag = flag.String("bin", "", "Path to the HappyUC contract bytecode (generate deploy method)")
	typFlag = flag.String("type", "", "Struct name for the binding (default = package name)")

	solFlag  = flag.String("sol", "", "Path to the HappyUC contract Solidity source to build and bind")
