...
func tmpdir(t *testing.T) string {
	dir, err := ioutil.TempDir("", "girc-test")
	if err != nil {
		t.Fatal(err)
	}
	return dir
...
func init() {
	// Run the app if we've been exec'd as "girc-test" in runGhuc.
	reexec.Register("girc-test", func() {
...
// spawns girc with the given command line args. If the args don't set --datadir, the
...
func runGhuc(t *testing.T, args ...string) *testghuc {
	...
	// Boot "girc". This actually runs the test binary but the TestMain
	// function will prevent any tests from running.
	tt.Run("girc-test", args...)
