...
var (
	walletCommand = cli.Command{
		Name:      "wallet",
		Usage:     "Manage HappyUC presale wallets",
		ArgsUsage: "",
		Category:  "ACCOUNT COMMANDS",
		Description: `
    ghuc wallet import /path/to/my/presale.wallet

will prompt for your password and imports your happyuc presale account.
		...
		Subcommands: []cli.Command{
			{
				...
				Name:      "import",
				Usage:     "Import HappyUC presale wallet",
				ArgsUsage: "<keyFile>",
				...
				Description: `
	ghuc wallet [options] /path/to/my/presale.wallet
...
between happyuc nodes by simply copying.
...
For non-interactive use the passphrase can be specified with the --password flag:
    ...
    ghuc account update [options] <address>
...
For non-interactive use the passphrase can be specified with the -password flag:
    ...
    ghuc account import [options] <keyfile>

Note:
As you can directly copy your encrypted accounts to another happyuc instance,
...
func accountCreate(ctx *cli.Context) error {
	cfg := ghucConfig{Node: defaultNodeConfig()}
	// Load config file.
