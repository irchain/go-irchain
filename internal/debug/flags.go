...
import (
	...
	"github.com/irchain/go-irchain/log/term"
	"github.com/irchain/go-irchain/metrics"
	"github.com/irchain/go-irchain/metrics/exp"
...
var (
	...
	vmoduleFlag = cli.StringFlag{
		Name:  "vmodule",
		Usage: "Per-module verbosity: comma-separated list of <pattern>=<level> (e.g. irc/*=5,p2p=4)",
		Value: "",
	}
