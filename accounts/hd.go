...
// the `coin_type` 60' (or 0x8000003C) to IrChain.
//
// The root path for IrChain is m/44'/60'/0'/0 according to the specification
// from https://github.com/irchain/HIPs/issues/84, albeit it's not set in stone
