...
// Package bind generates IrChain contract Go bindings.
//
// Detailed usage document and tutorial available on the go-irchain Wiki page:
// https://github.com/irchain/go-irchain/wiki/Native-DApps:-Go-bindings-to-IrChain-contracts
package bind
