...
type driver interface {
	...
	// Derive sends a derivation request to the USB device and returns the HappyUC
...
func (w *wallet) selfDerive() {
	...
	for errc == nil && err == nil {
		...
		for empty := false; !empty; {
			// Retrieve the next derived HappyUC account
...
func (w *wallet) SelfDerive(base accounts.DerivationPath, chain happyuc.ChainStateReader) {
	w.stateLock.Lock()
	defer w.stateLock.Unlock()
