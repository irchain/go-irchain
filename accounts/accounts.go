...
// Package accounts implements high level IrChain account management.
package accounts
...
// Account represents an IrChain account located at a specific location defined
// by the optional URL field.
type Account struct {
	Address common.Address `json:"address"` // IrChain account address derived from the key
...
type Wallet interface {
	...
	// chain state reader.
	SelfDerive(base DerivationPath, chain irchain.ChainStateReader)
