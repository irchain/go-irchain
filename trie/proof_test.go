...
// test all variations.
func makeProvers(trie *Trie) []func(key []byte) *hucdb.MemDatabase {
	var provers []func(key []byte) *hucdb.MemDatabase

	// Create a direct trie based Merkle prover
	provers = append(provers, func(key []byte) *hucdb.MemDatabase {
		proof := hucdb.NewMemDatabase()
