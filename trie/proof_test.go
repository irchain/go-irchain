...
// test all variations.
func makeProvers(trie *Trie) []func(key []byte) *ircdb.MemDatabase {
	var provers []func(key []byte) *ircdb.MemDatabase

	// Create a direct trie based Merkle prover
	provers = append(provers, func(key []byte) *ircdb.MemDatabase {
		proof := ircdb.NewMemDatabase()
