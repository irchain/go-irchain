...
// Tests that irchash works correctly in test mode.
...
// It reproduces https://github.com/irchain/go-irchain/issues/14943
func TestCacheFileEvict(t *testing.T) {
	tmpdir, err := ioutil.TempDir("", "irchash-test")
	if err != nil {
		t.Fatal(err)
	}
...
func verifyTest(wg *sync.WaitGroup, e *Irchash, workerIndex, epochs int) {
	defer wg.Done()
