...
func loadSnapshot(config *params.CliqueConfig, sigcache *lru.ARCCache, db ircdb.Database, hash common.Hash) (*Snapshot, error) {
...
func (s *Snapshot) store(db ircdb.Database) error {
