...
func (api *PublicHappyUCAPI) Etherbase() (common.Address, error) {
...
func NewPublicDebugAPI(eth *HappyUC) *PublicDebugAPI {
...
func NewPrivateDebugAPI(config *params.ChainConfig, eth *HappyUC) *PrivateDebugAPI {
