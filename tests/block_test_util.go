...
// Package tests implements execution of HappyUC JSON tests.
package tests
...
func (t *BlockTest) Run() error {
	...
	chain, err := core.NewBlockChain(db, nil, config, hucash.NewShared(), vm.Config{})
	if err != nil {
		return err
	}
	defer chain.Stop()
...
/* See https://github.com/happyuc-project/tests/wiki/Blockchain-Tests-II
