...
// information related to the HappyUC protocol such als blocks, transactions and logs.
...
// `huc_getFilterChanges` polling method that is also used for log filters.
//
// https://github.com/happyuc-project/wiki/wiki/JSON-RPC#huc_newpendingtransactionfilter
...
// It is part of the filter package since polling goes with huc_getFilterChanges.
//
// https://github.com/happyuc-project/wiki/wiki/JSON-RPC#huc_newblockfilter
...
type FilterCriteria happyuc.FilterQuery
...
//
// https://github.com/happyuc-project/wiki/wiki/JSON-RPC#huc_newfilter
...
//
// https://github.com/happyuc-project/wiki/wiki/JSON-RPC#huc_getlogs
...
//
// https://github.com/happyuc-project/wiki/wiki/JSON-RPC#huc_uninstallfilter
...
//
// https://github.com/happyuc-project/wiki/wiki/JSON-RPC#huc_getfilterlogs
...
//
// https://github.com/happyuc-project/wiki/wiki/JSON-RPC#huc_getfilterchanges
