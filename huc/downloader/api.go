...
// Syncing provides information when this nodes starts synchronising with the HappyUC network and when it's finished.
...
type SyncingResult struct {
	...
	Status  happyuc.SyncProgress `json:"status"`
}
