...
// ProtocolVersions are the upported versions of the huc protocol (first is primary).
...
// huc protocol message codes
const (
	// Protocol messages belonging to huc/62
	StatusMsg          = 0x00
	...
	// Protocol messages belonging to huc/63
	GetNodeDataMsg = 0x0d
	NodeDataMsg    = 0x0e
	GetReceiptsMsg = 0x0f
	ReceiptsMsg    = 0x10
