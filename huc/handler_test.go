...
func testGetNodeData(t *testing.T, protocol int) {
	...
	statedb, _ := hucdb.NewMemDatabase()
...
// Tests that post huc protocol handshake, DAO fork-enabled clients also execute
...
func testDAOChallenge(t *testing.T, localForked, remoteForked bool, timeout bool) {
	...
	if !timeout {
		blocks, _ := core.GenerateChain(&params.ChainConfig{}, genesis, huchash.NewFaker(), db, 1, func(i int, block *core.BlockGen) {
			if remoteForked {
